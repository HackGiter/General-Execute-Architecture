...
accelerate launch --config_file gea/self/$project/$version/accelerate_config.yaml -m gea.self.$project.$version.xhead_executor \
    ...
    --project /data/lhz/manual/model/3E/$project/0818 \
    --tensorboard_project /data/lhz/manual/model/3E/TENSORBOARD/NEW/$project/0818 \
    --optim adamw \
    ...
    --path /data/lhz/manual/model/3E/$project/0818/ \