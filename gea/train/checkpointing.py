...
from ..utils.constant import LAYERNORM_NAMES
...
def upcast_layernorm(model: "PreTrainedModel") -> None:
    r"""
...
def gradient_checkpoint(model: "PreTrainedModel", use_unsloth_gc:bool=False) -> None:
    r"""
    ...
    if not getattr(model, "supports_gradient_checkpointing", False):
        ...
        gradient_checkpointing_enable = partial(
            _gradient_checkpointing_enable, use_unsloth_gc=use_unsloth_gc
        )
...
def upcast_lmhead_output(model: "PreTrainedModel") -> None:
    r"""
    add the upcasting of the lm_head in fp32
    """
